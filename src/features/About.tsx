      ...
      <div className="container">
        <div className="section-title">
          ...
          <p>
            ...
            there will be over engineering on this website. You can review the
            codebase of this website on my public GitHub repository.
          </p>
        </div>
        <div className="row">
          ...
          <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <p className="fst-italic">
              ...
              games. I am a curious person and I like to research lots of topics
              which mostly related to my profession
            </p>
            <div className="row">
