        ...
        >
          ...
          >
            ...
            <p>
              ...
              and its product is a online data scientist tool. It provides ready
              to use model training web application which is powered by machine
              learning algorithms.
            </p>
            <p>
          ...
          >
            ...
            <p>
              ...
              project requirements changed while development process. Because of
              this agile development methodologies applied.
            </p>
            <p>
          ...
          >
            ...
            <p>
              ...
              biggest engineering problem in this project is provide smooth
          ...
          >
            ...
            <p>
              ...
              the desktop and mobile with 50 participants limit. The biggest
              engineering problem is provide smooth video conference experience
              without video and audio loss with these much participants.
            </p>
            <p>
          ...
          <div className={"col-lg-6 portfolio-item filter-" + FILTERS.CPP}>
            ...
            <p>
              ...
              project generate 200 surface track in maximum 30 milliseconds(2hz)
              and send this data over udp to system under test machine. This
              data generated in real time for creating a surface track
              simulator.
            </p>
            <p>
            ...
            <p>
              ...
              Doxygen, GoogleTest, Jenkins, SonarQube, Valgrind (Memory Leak),
          ...
          >
            ...
            <p>
              This project is a web application which can be managed military
          ...
          <div className={"col-lg-6 portfolio-item filter-" + FILTERS.PHP}>
            ...
            <p>
              ...
              service integrated to the company`s ERP software with a interface
              for customers to create their virtual phone switchboard
            </p>
            <p>
              Technologies and Methods Used: Symfony Php Framework, Doctrine,
              Bootstrap, Jquery, MsSQL, PostgreSQL, Restful Web Service, MVC
            </p>
          </div>
          <div className={"col-lg-6 portfolio-item filter-" + FILTERS.PHP}>
            ...
            <p>
              The company has a application which track their application and if
              an error occurred, send a sms to the related tech personal. This
              application do not have an interface which I wrote it in php as a
              first experience on this language.
            </p>
            <p>
          ...
          <div className={"col-lg-6 portfolio-item filter-" + FILTERS.PHP}>
            ...
            <p>
              ...
              management. It wrote by the company and it needs a project
              management system which can be link to workflow. With these
